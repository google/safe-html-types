...
/**
 * <a href="https://github.com/google/safe-html-types/blob/main/doc/safehtml-unchecked.md">
 * Guidelines for Use of Unchecked Conversions</a> explains when to use the {@code
 * UncheckedConversions} APIs and what someone seeking or granting approval should do.
 *
 * <p>The <a
 * href="https://github.com/google/safe-html-types/blob/main/examples/banned_use_of_unchecked_conversions/pom.xml">pom.xml</a>
