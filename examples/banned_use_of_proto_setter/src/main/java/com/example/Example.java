...
/**
 * Safe string values can be serialized and deserialized as <a
 * href="https://developers.google.com/protocol-buffers/">protocol buffers</a> but naive use of the
 * protocol buffer builders can result in values that do not obey the <a
 * href="https://github.com/google/safe-html-types/blob/main/doc/safehtml-types.md">type
 * contract</a>.
 *
 * <p>The <a
 * href="https://github.com/google/safe-html-types/blob/main/examples/banned_use_of_proto_setter/pom.xml">pom.xml</a>
 * file shows how the <a href="http://mikesamuel.github.io/fences-maven-enforcer-rule/">fences
 * rule</a> can verify that all uses have been reviewed and guide developers towards less easily
 * misused APIs.
 */
